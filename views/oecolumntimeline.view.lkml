view: oecolumntimeline {
  sql_table_name: ovaledgedb.oecolumntimeline ;;
  drill_fields: [oecolumntimelineid]

  dimension: oecolumntimelineid {
    primary_key: yes
    type: number
    sql: ${TABLE}.oecolumntimelineid ;;
  }
  ...
  set: detail {
    fields: [
      oecolumntimelineid,
      columnname,
      oetabletimeline.oetabletimelineid,
      oecolumn.oecolumnid,
      oecolumn.columnname,
      oetable.oetableid,
      oetable.tablename,
